                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php
                            if (isset($_SESSION['email'])) { ?>
                                <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="fullname" placeholder="Enter your full name" />
                            <?php
                            } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            if (isset($_SESSION['email'])) { ?>
                                ...
                                <input type="email" name="email" class="form-control" value="<?php echo $email_id; ?>" id="email" aria-describedby="emailHelp" placeholder="Enter your email address">
