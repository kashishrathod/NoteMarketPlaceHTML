...
$query = "SELECT DISTINCT seller_notes.seller_note_id, seller_notes.note_title, seller_notes.category,
 ...
 seller_notes.seller_note_id=seller_notes_review.note_id WHERE note_title LIKE '%$search1%'";
...
$query_page = "SELECT COUNT(seller_note_id) FROM seller_notes WHERE note_title LIKE '%$search1%'";
		...
		<div class="row">
			...
			?>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<?php echo "<a href='http://localhost/notes-project/Notes/notedetails.php?id=$noteid' style='text-decoration: none;'>"; ?>
