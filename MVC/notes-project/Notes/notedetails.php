                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="row">
                        <div class="col-md-5 col-12">
                            <img src="img/notedetails/first.jpg" alt="book" class="img-fluid" style="height: 300px">
                        </div>
                        <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                           ...
                           echo "<a role='button' type='submit' name='download' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>DOWNLOAD / $15</a>";
                            }
                            else{
                                ?>
                                <a role='button' type='submit' name='download' class='btn btn-primary' onclick="window.location.href='login.php';">DOWNLOAD / $15</a>
                             <?php   
                            }
                            ?>
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="container border-black">
                        <div class="row bottom-black">
                            <div class="col-md-2">
                                <img src="img/notedetails/reviewer-1.png" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="col-md-10">
                                <h6>Richard Brown</h6>
                        ...
                        <div class="row bottom-black">
                            <div class="col-md-2">
                                <img src="img/notedetails/reviewer-2.png" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="col-md-10">
                                <h6>Alice Ortiaz</h6>
                                <div class="rate2 rate-space">
                                    <div class="rate"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <img src="img/notedetails/reviewer-3.png" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="col-md-10">
                                <h6>Sara Passmore</h6>
                                <div class="rate3 rate-space">
                                    <div class="rate"></div>
                                </div>
