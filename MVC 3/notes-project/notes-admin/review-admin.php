...
<div class="container border-black">
    ...
    LEFT JOIN user_profile ON users.userid = user_profile.user_id WHERE seller_notes_review.note_id='$id1' AND seller_notes_review.isactive=1");
    if(!$review_data){
    ...
    ?>
        <div class="row bottom-black">
            <div style="display: flex;">
                ...
                <?php  echo "<a href='delete-customer-review.php?note_id=$id1&user_id=$review_id'><img src='img/administrator/delete.png' alt='delete' style='transform: translateX(200px);'></a>"; ?>
                </div>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-10">
                <p style="margin-left: 100px; margin-top:2px;"><?php echo $comment; ?></p>
            </div>
        <?php  } else {
                        echo "no review";
                    }
