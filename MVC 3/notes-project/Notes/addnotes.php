...
if (isset($_SESSION['email'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_POST['yes-popup'])) {
            $publish = mysqli_query($conn, "UPDATE seller_notes SET status=7 WHERE seller_note_id=$id1");
        ...
        $query = "INSERT INTO seller_notes(seller_id, status, publisheddate, note_title, category, display_picture, 
            ...
            VALUES ($id ,6, NOW(), '$title', $category , '../Member/14profile-pic-1617128757.png', $notetype, $pages, 
                        ...
                        <div class="form-group">
                            ...
                            <select id="country" name="country" class="form-control arrow-down">
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $query_country = "select * from countries WHERE isactive=1";
