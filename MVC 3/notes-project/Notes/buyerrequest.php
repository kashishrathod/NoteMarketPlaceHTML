                ...
                <table id="myTable" class="table border buyer-width">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='notedetails.php?id=$note_id'><img src='img/dashboard/eye.png' alt='delete' class='eye-img'></a>";
                            ...
                            echo "<a class='dropdown-item' href='buyerrequest.php?id=$note_id'>Allow Download</a>";
                            if (isset($_GET['id'])) {
                                $id1 = $_GET['id'];
