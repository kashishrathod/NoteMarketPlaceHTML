                ...
                <table id="myTable" class="table border dashboard-width">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($ref_value == 'Draft') {
                                echo "<td>
                                     <a href='addnotes.php?id=$seller_note_id'><img src='img/dashboard/edit.png' alt='edit'></a>
                                     <a href='delete.php?act=edit&id=$seller_note_id'><img src='img/dashboard/delete.png' alt='delete'></a>
                                     </td>";
                            } else {
                                echo "<td>
