...
if (isset($_POST['signup'])) {
    ...
    if ($check == 0 && $password_match && $length_check && $lname_validation && $fname_validation && $email_validation) {
                    ...
                    <form action="signup.php" method="POST" class="white-bg-signup">
                        ...
                        <div class="form-group signup-label">
                            ...
                            <div class="password">
                                ...
                                <img src="img/pre-login/eye.png" class="toggle-password" toggle="#conpassword">
                            </div>
