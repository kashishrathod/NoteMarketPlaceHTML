...
$validation_3 = true;
   ...
   if(isset($_GET['id'])){
        ...
        $get_details = mysqli_query($conn, "SELECT * FROM seller_notes WHERE seller_note_id=$ids");
        ...
        if(isset($_POST['save'])){
            ...
            course_code=$course_code, professor='$professor', ispaid=$free, selling_price=$price WHERE seller_note_id=$ids";
