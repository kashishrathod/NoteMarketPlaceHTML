            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table text-center border general-table-width spam-report-table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>khyati patel</td>
                                    <td class="diff-color">Software Development</td>
                                    <td>IT</td>
                                    <td>09-10-2020,10:10</td>
                                    <td>lorem ipsum is simply a dummy text</td>
                                    <td><img src="img/administrator/delete.png" alt="delete">
                                    </td>
                                    <td>
