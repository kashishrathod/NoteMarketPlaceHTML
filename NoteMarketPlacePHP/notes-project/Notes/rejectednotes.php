            ...
            <div class="row">
                <div class="col-md-12">
                   <div class="table-responsive">
                    <table class="table text-center border general-table-width rejected-notes-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Data Science</td>
                                <td>Science</td>
                                <td>Lorem ipsum dolor sit ametwuj</td>
                                <td>clone</td>
                                <td><img src="img/dashboard/eye.png" alt="delete"></td>
